  ...
  return (
    <section className="mx-auto flex min-h-[calc(100vh-73px)] max-w-xl items-center px-4 py-12">
      <div className="w-full rounded-lg border border-neutral-200 bg-white p-6 shadow-sm">
        <p className="font-display text-xs font-semibold tracking-[0.16em] text-neutral-500 uppercase">Public signup form</p>
        <h1 className="font-display mt-3 text-2xl font-semibold text-neutral-950">Subscribe to this newsletter</h1>
